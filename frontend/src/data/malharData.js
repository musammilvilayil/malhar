export const siteData = {
  ...
  institutions: [
    ...
    },
    {
      ...
      slug: 'buds-school',
      description: 'ZeeQue preschool learning for ages 3–6 across LZQ, MZQ and UZQ stages, nurturing creativity, collaboration and joyful learning.',
      image: '/assets/zq-3.png',
      programs: ['LZQ', 'MZQ', 'UZQ'],
      features: ['Preschool Education', 'Creative Learning', 'Collaborative Learning'],
    },
  ],
  ...
  institutionDetails: [
    ...
    { slug: 'buds-school', headline: 'ZeeQue preschool learning for ages 3–6.', description: 'She Garden Buds School supports early childhood learning through LZQ, MZQ and UZQ stages.', overview: 'The programme focuses on creativity, collaboration and joyful learning.', programs: ['LZQ', 'MZQ', 'UZQ'], admission: 'Contact the institution for current admission information.', eligibility: 'Contact the institution for current eligibility requirements.', contact: 'Malhar Administration', phone: '8891001205' },
  ],
